<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('home') }}" target="_blank">
            ...
            <span class="ms-1 font-weight-bold">Sistem Aduan Kerosakan</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'permission') == true ? 'active' : '' }}"
            ...
            {{-- Pentadbir --}}
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'administrator/complaints') == true ? 'active' : '' }}"
                    href="">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-single-copy-04 text-warning text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Aduan - Pentadbir</span>
                </a>
            </li>
            {{-- Pengadu --}}
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'complainant/complaints') == true ? 'active' : '' }}"
                    href="">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-single-copy-04 text-warning text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Aduan - Pengadu</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'borang1') == true ? 'active' : '' }}"
                    href="{{ route('borang1') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-single-copy-04 text-warning text-sm opacity-10"></i>
